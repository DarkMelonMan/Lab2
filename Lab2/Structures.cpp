...
LivingEntityStruct livingEntityCreateInstance(char* name, double healthPoints, double movementSpeed) {
	LivingEntityStruct livingEntity;
	livingEntity.healthPoints = (double*)malloc(sizeof(double));
...
LivingEntityStruct livingEntityInput(EntityType type) {
...
void livingEntityOutput(LivingEntityStruct livingEntity) {
...
void livingEntityHurt(LivingEntityStruct livingEntity, double damage) {
	*livingEntity.healthPoints -= damage;
	isDead(livingEntity);
}

int isDead(LivingEntityStruct livingEntity) {
...
MonsterEntityStruct monsterEntityCreateInstance(char* name, double healthPoints, double movementSpeed, double baseDamage, double elementDamage, Element damageType, Element weakness) {
...
MonsterEntityStruct monsterEntityInput() {
...
void monsterEntityHurt(MonsterEntityStruct monster, double baseDamage, double elementDamage, Element damageType) {
...
void monsterEntityAttack(MonsterEntityStruct monster, PlayerEntityStruct player) {
...
void monsterEntityOutput(MonsterEntityStruct monsterEntity) {
...
ArmorStruct armorCreateInstance(double baseDefence, double elementDefence, Element defenceType) {
	ArmorStruct armor;
...
void armorOutput(ArmorStruct armor) {
...
WeaponStruct weaponCreateInstance(double baseDamage, double elementDamage, Element damageType) {
	WeaponStruct weapon;
...
void weaponOutput(WeaponStruct weapon) {
...
PlayerEntityStruct playerEntityCreateInstance(char* name, double healthPoints, double movementSpeed, WeaponStruct equippedWeapon, ArmorStruct equippedArmor) {
...
PlayerEntityStruct playerEntityInput() {
...
void playerEntityOutput(PlayerEntityStruct entity) {
	printf("\nPlayer armor:\n");
...
void playerEntityHurt(PlayerEntityStruct player, double damage) {
	livingEntityHurt(player.entity, damage);
}

void playerEntityAttack(PlayerEntityStruct player, MonsterEntityStruct monster) {
